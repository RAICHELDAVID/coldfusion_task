...
<body>
    ...
    <ul>
    <cfloop query="pages">
        <li>#pages.pagename# - #pages.pagedesc# <a href="edit_page.cfm?pageid=#pages.pageid#">Edit</a> 
        <a href="delete_page.cfm?pageid=#pages.pageid#">Delete</a></li>
    </cfloop>
</ul>
<!---<cfform>
     <cfinput type="Button" name="delete" id="deleteButton" onclick="#calculateTotal()#">
</cfform--->
